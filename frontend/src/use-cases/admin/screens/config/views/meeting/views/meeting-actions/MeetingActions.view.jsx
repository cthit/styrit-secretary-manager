...
import { MeetingActionButtonContainer, MeetingActionsContainer } from "./MeetingActions.styles.view.jsx.";
    ...
    return (
        <MeetingActionsContainer>
            ...
            <MeetingActionButtonContainer>
                ...
                <DigitButton raised primary
                             onClick={() => props.downloadArchive(props.meeting.id)} text={"Download archive"}
                             size={{width: "100%"}} />
            </MeetingActionButtonContainer>
        </MeetingActionsContainer>
    )
